...
// Listas de marcas (Tu diseño original)
const CAR_MAKES = [
...
const VehicleProfileSetup: React.FC = () => {
    ...
    // Recuperamos el tipo (coche/moto) de la pantalla anterior
    ...
    const handleSave = async () => {
        ...
        // Guardamos los datos combinados en la columna 'name' para evitar errores de base de datos
        // (Ej: "Audi A3 - 120000km")
        const fullName = `${make} ${model} ${mileage ? `- ${mileage}km` : ''}`;
    ...
    return (
        <div className="bg-gray-50 dark:bg-[#111813] min-h-screen flex flex-col relative overflow-x-hidden">
            {/* Decoración de fondo */}
                ...
                <div className="w-full max-w-[580px] bg-white dark:bg-[#1a2920] rounded-2xl shadow-xl border border-gray-100 dark:border-[#2a3f32] overflow-hidden flex flex-col">
                    ...
                    <div className="px-8 pt-8 pb-4">
                        <div className="flex justify-between items-end mb-3">
                            <div className="flex flex-col gap-1">
                                <span className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Paso 2 de 2</span>
                    ...
                    <div className="p-8 mt-4 bg-gray-50 dark:bg-[#15231b] border-t border-gray-100 dark:border-[#2a3f32]">
                        <button
                            ...
                            className={`w-full h-14 font-bold text-lg rounded-xl shadow-lg transition-all duration-300 flex items-center justify-center gap-3 relative overflow-hidden ${!make || loading ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 text-white shadow-blue-500/20'}`}
                        >
